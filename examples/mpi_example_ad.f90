...
contains
  ...
  subroutine isend_irecv_fwd_ad(x, x_ad, y, y_ad, comm)
    ...
    y_ad = x_ad(2) ! y = x(2)
    y = x(2)
    call MPI_Wait_fwd_ad(reqs, reqs_ad, MPI_STATUS_IGNORE, MPI_STATUS_IGNORE, ierr)
    call MPI_Wait_fwd_ad(reqr, reqr_ad, MPI_STATUS_IGNORE, MPI_STATUS_IGNORE, ierr)
  ...
  subroutine isend_irecv_rev_ad(x, x_ad, y_ad, comm)
    ...
    call MPI_Wait_fwd_rev_ad(reqs_ad, ierr)
    call MPI_Wait_fwd_rev_ad(reqr_ad, ierr)
