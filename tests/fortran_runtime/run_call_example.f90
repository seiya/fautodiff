program run_call_example
  ...
  integer, parameter :: I_call_subroutine_fwd = 1
  integer, parameter :: I_call_subroutine_rev = 2
  integer, parameter :: I_call_fucntion_fwd = 3
  integer, parameter :: I_call_fucntion_rev = 4
  integer, parameter :: I_arg_operation_fwd = 5
  integer, parameter :: I_arg_operation_rev = 6
  integer, parameter :: I_arg_function_fwd = 7
  integer, parameter :: I_arg_function_rev = 8
