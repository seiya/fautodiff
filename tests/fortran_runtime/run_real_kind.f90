program run_real_kind
  ...
  integer, parameter :: I_scale_8_fwd = 1
  integer, parameter :: I_scale_8_rev = 2
  integer, parameter :: I_scale_rp_fwd = 3
  integer, parameter :: I_scale_rp_rev = 4
  integer, parameter :: I_scale_dp_fwd = 5
  integer, parameter :: I_scale_dp_rev = 6
